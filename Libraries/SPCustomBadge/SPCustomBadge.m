...
{
	return [self initWithString:badgeString withStringColor:[UIColor whiteColor] withInsetColor:[UIColor redColor] withBadgeFrame:YES withBadgeFrameColor:[UIColor whiteColor] withScale:scale withShining:shining];
}
...
- (id) initWithString:(NSString *)badgeString withStringColor:(UIColor*)stringColor withInsetColor:(UIColor*)insetColor withBadgeFrame:(BOOL)badgeFrameYesNo withBadgeFrameColor:(UIColor*)frameColor withScale:(CGFloat)scale withShining:(BOOL)shining 
{
	...
	if(self!=nil) {
		...
		self.badgeShadow = [TPWiOSVersions isLessThanVersion:@"7.0"];
...
+ (SPCustomBadge*) customBadgeWithString:(NSString *)badgeString
{
...
+ (SPCustomBadge*) customBadgeWithString:(NSString *)badgeString withStringColor:(UIColor*)stringColor withInsetColor:(UIColor*)insetColor withBadgeFrame:(BOOL)badgeFrameYesNo withBadgeFrameColor:(UIColor*)frameColor withScale:(CGFloat)scale withShining:(BOOL)shining
{
...
- (void)setBadgeShadow:(BOOL)badgeShadow {
	if (badgeShadow) {
		self.layer.shadowColor = [[UIColor tpwShadowColor] CGColor];
